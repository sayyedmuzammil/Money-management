...
The MoneyX app stores and processes personal data that you have provided to us, to provide my Service. It's your responsibility to keep your phone and access to the app secure. We therefore recommend that you do not jailbreak or root your phone, which is the process of removing software restrictions and limitations imposed by the official operating system of your device. It could make your phone vulnerable to malware/ viruses/malicious programs, compromise your phone's security features and it could mean that the MoneyX app won't work properly or at all.

The app does use third-party services that declare their Terms and Conditions.

Along the same lines, Sayyed Muzammil cannot always take responsibility for the way you use the app i.e. You need to make sure that your device stays charged - if it runs out of battery and you can't turn it on to avail the Service, Sayyed Muzammil cannot accept responsibility.
...
These terms and conditions are effective as of $pastMonth.''',
  strutStyle: Styles.paragraphStructStyle, 
    ...
    /*   //              ExpansionTile(
      ...
      // // onExpansionChanged: Void isexpand(){},
      
      //               // trailing: const ImageIcon(
      //               //   AssetImage('assets/images/plus and minus.png'),
      //               // ),
